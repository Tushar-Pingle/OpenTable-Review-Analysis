...
### [Rating Overview Dashboard](https://public.tableau.com/views/OpenTableRatingOverview/Dashboard1?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link)
...
### [Sentiment Analysis Over Time](https://public.tableau.com/views/OpenTableRatingOverview_17071810318720/Comparingtrendsofratingandsentimentscore?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link)
...
### [Aspect Analysis Visualization](https://public.tableau.com/views/AspectAnalysis_/AspectAnalysis?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link)
...
## Next Steps
I will be diving further deep into each restaurant individually to further analyze the positive and negetive aspects and trying to find the pain points in the operations mentioned by the customers.
